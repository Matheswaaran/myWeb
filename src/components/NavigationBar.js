...
class NavigationBar extends React.Component {
    ...
    render() {
        return (
            <StaticQuery
                query={graphql`query { dataJson { name socialLinks { fb twitter g_plus linkedIn instagram github } } }`}
                render={(data) => (
                    <div>
                        <div className="menu-responsive">
                            <a href="#home">{data.dataJson.name}</a>
                        ...
                        <header className={this.state.responsive ? "header-container responsive" : "header-container"}>
                            ...
                            <div className="menu-footer">
                                ...
                                <div className="copyright">
                                    <p>&copy; {data.dataJson.name} <br/>all right reserved</p>
                                </div>
                            </div>
                        </header>
                    </div>
